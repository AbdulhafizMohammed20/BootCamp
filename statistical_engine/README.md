...
```bash
git clone https://github.com/AbdulhafizMohammed20/BootCamp
...
* ✔️ Handles empty data
* ✔️ Handles invalid data types
* ✔️ Supports multimodal distributions
* ✔️ Correct sample vs population variance
* ✔️ Detects outliers correctly